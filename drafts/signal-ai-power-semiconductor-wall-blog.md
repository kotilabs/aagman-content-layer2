...
Some signals only make sense once you see that they have happened before, in different clothes. Two episodes are worth sitting with.

### The telecom fiber buildout, 1999–2000

In the late 1990s, the internet stopped being a curiosity and started being priced as if it would swallow the economy whole. Telecom carriers raised enormous sums. Undersea cables were laid across the Atlantic and Pacific. Metropolitan fiber rings were dug into city streets. The equipment vendors that supplied the optical switches, amplifiers, dense wavelength-division multiplexing gear, power systems, and cooling infrastructure could not keep up. Lead times stretched. Prices rose. Venture capitalists and equity analysts wrote reports explaining why the demand curve had shifted permanently.

For a brief period, the shortage was real. Then the demand failed to fill the capacity that had been built. WorldCom collapsed in 2002, Global Crossing in 2002, and a long list of optical-component vendors either went bankrupt or never recovered. The oversupply of fiber and equipment lasted for the better part of a decade. More importantly, the supply-chain scarring lingered: cancelled purchase commitments, fabs that were never built, engineering talent that left the industry, and a collective memory among suppliers that made them cautious when real demand returned in the 2010s.

The lesson is not simply that bubbles burst. It is that physical infrastructure buildouts can run years ahead of the revenue that justifies them, and that the suppliers of the unglamorous enabling layer often suffer the worst hangover. The AI buildout is not identical. The demand for AI services is more tangible than the demand for pet-food delivery websites in 1999. But the risk is the same: hyperscalers can order GPUs and data-center shells faster than the power grid, transformer manufacturers, and mature-node foundries can scale to meet them. If the pace of capex slows, the enabling layer will be left with excess capacity. If the pace stays high, the enabling layer will remain the bottleneck. Either way, the location of the constraint has moved downstream from the headline compute layer.

### The pandemic semiconductor shortage, 2020–2022

The shortage that followed COVID-19 is closer in time and more directly analogous. In early 2020, automakers cut chip orders, assuming vehicle sales would collapse. Consumer-electronics companies, laptop makers, and data-center operators kept ordering. When car demand rebounded faster than expected, automakers tried to reorder — and found that mature-node foundry capacity had been reallocated to higher-margin chips for laptops, servers, gaming consoles, and smartphones.

The shortage was not in the most advanced nodes. It was in the older processes that the AI boom is now also squeezing: 28-nanometer and above, 200-mm wafer fabs, Bipolar-CMOS-DMOS processes used for power management, motor control, and analog functions. Lead times for automotive microcontrollers stretched past 40 weeks. Carmakers idled plants. Used-vehicle prices spiked. The shortage lasted long enough that governments in the US, EU, and Japan launched subsidy programs to bring more mature-node capacity back onshore.

The same allocation logic is visible now. AI servers are not just consuming GPUs; they are consuming the mature-node power components that automotive, industrial, medical, and consumer devices also need. TSMC and Samsung are scaling back 8-inch output even as AI demand rises. Infineon, STMicroelectronics, and ON Semiconductor are raising capex for power semiconductors, but new capacity takes years to build. The lesson is that the most constrained nodes are often not the ones on the leading-edge roadmap that get the headlines. They are the older, cheaper, more commoditized processes where investment lagged because nobody thought they were exciting. Once those nodes tighten, the shortage can last for years, not quarters, because expanding them is neither fast nor fashionable.
